...
const s3AccessToken = envOrThrow("AWS_ACCESS_KEY_ID");
const s3SecretAccessToken = envOrThrow("AWS_SECRET_ACCESS_KEY");
...
export const cfg: ApiConfig = {
  ...
  s3Client: new S3Client({
    accessKeyId: s3AccessToken,
    secretAccessKey: s3SecretAccessToken,
    bucket: s3Bucket
  })
};
